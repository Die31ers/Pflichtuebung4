...
public class Testklasse {
	...
	@Test
	public void testeMap1() {
		assertEquals(true, cinmax.map.containsKey(s2));
	}

	@Test
	public void testeMap2() {
		assertEquals(true, cinmax.map.containsKey(s3));
	}

	@Test
	public void testeFreigaberegelung() {
		assertEquals(false, cinmax.map.containsValue(s2));
	}

	@Test
	public void testeFilmvorhanden() {
		initialize();
		assertEquals(m, cinmax.getFilmeFuerSaalMitZeiten(s1));
	}
